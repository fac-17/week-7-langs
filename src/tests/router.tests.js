  ...
  supertest(router)
    ...
    .end((err, res) => {
      ...
      t.equal(
        ...
        "text/html",
        "home route returns correct content type"
      );
      t.end();
    });
});
  ...
  supertest(router)
    ...
    .end((err, res) => {
      ...
      t.equal(
        res.headers["content-type"],
        "text/css",
        "style.css route returns correct content type"
      );
    });
  ...
  supertest(router)
    ...
    .end((err, res) => {
      ...
      t.equal(
        ...
        "dom.js route returns correct content type"
      );
      t.end();
    });
});
...
// tape(
//   "Register route responds with 302 and redirects to about.html on successful registration",
//   t => {
//     supertest(router)
//       .get("/register")
//       .end((err, res) => {
//         t.error(
//           err,
//           "Register route responds with 302 and redirects to about on successful registration"
//         );
